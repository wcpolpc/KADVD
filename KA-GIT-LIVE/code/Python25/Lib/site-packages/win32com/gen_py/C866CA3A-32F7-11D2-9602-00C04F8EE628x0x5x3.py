...
class constants:
	...
	SPEI_RESERVED4                =53         # from enum SPEVENTENUM
...
# This CoClass is known by the name 'SAPI.SpPhoneticAlphabetConverter.1'
...
ISpDataKey_vtables_ = [
	(( u'SetData' , u'pszValueName' , u'cbData' , u'pData' , ), 1610678272, (1610678272, (), [ 
			(31, 0, None, None) , (19, 0, None, None) , (16401, 0, None, None) , ], 1 , 1 , 4 , 0 , 12 , (3, 0, None, None) , 0 , )),
	(( u'GetData' , u'pszValueName' , u'pcbData' , u'pData' , ), 1610678273, (1610678273, (), [ 
			(31, 0, None, None) , (16403, 0, None, None) , (16401, 0, None, None) , ], 1 , 1 , 4 , 0 , 16 , (3, 0, None, None) , 0 , )),
	(( u'SetStringValue' , u'pszValueName' , u'pszValue' , ), 1610678274, (1610678274, (), [ (31, 1, None, None) , 
			(31, 0, None, None) , ], 1 , 1 , 4 , 0 , 20 , (3, 0, None, None) , 0 , )),
	...
	(( u'DeleteKey' , u'pszSubKey' , ), 1610678280, (1610678280, (), [ (31, 0, None, None) , ], 1 , 1 , 4 , 0 , 44 , (3, 0, None, None) , 0 , )),
...
ISpObjectToken_vtables_ = [
	(( u'SetId' , u'pszCategoryId' , u'pszTokenId' , u'fCreateIfNotExist' , ), 1610743808, (1610743808, (), [ 
			(31, 0, None, None) , (31, 0, None, None) , (3, 0, None, None) , ], 1 , 1 , 4 , 0 , 60 , (3, 0, None, None) , 0 , )),
...
ISpPhoneticAlphabetConverter_vtables_ = [
	...
	(( u'SetLangId' , u'LangId' , ), 1610678273, (1610678273, (), [ (18, 0, None, None) , ], 1 , 1 , 4 , 0 , 16 , (3, 0, None, None) , 0 , )),
	(( u'SAPI2UPS' , u'pszSAPIId' , u'pszUPSId' , u'cMaxLength' , ), 1610678274, (1610678274, (), [ 
			(16402, 1, None, None) , (16402, 2, None, None) , (19, 0, None, None) , ], 1 , 1 , 4 , 0 , 20 , (3, 0, None, None) , 0 , )),
	(( u'UPS2SAPI' , u'pszUPSId' , u'pszSAPIId' , u'cMaxLength' , ), 1610678275, (1610678275, (), [ 
			(16402, 1, None, None) , (16402, 2, None, None) , (19, 0, None, None) , ], 1 , 1 , 4 , 0 , 24 , (3, 0, None, None) , 0 , )),
	(( u'GetMaxConvertLength' , u'cSrcLength' , u'bSAPI2UPS' , u'pcMaxDestLength' , ), 1610678276, (1610678276, (), [ 
			(19, 0, None, None) , (3, 0, None, None) , (16403, 2, None, None) , ], 1 , 1 , 4 , 0 , 28 , (3, 0, None, None) , 0 , )),
]
...
ISpPhoneticAlphabetSelection_vtables_ = [
	...
	(( u'SetAlphabetToUPS' , u'fForceUPS' , ), 1610678273, (1610678273, (), [ (3, 0, None, None) , ], 1 , 1 , 4 , 0 , 16 , (3, 0, None, None) , 0 , )),
]
...
ISpRecoContext2_vtables_ = [
	...
	(( u'SetAdaptationData2' , u'pAdaptationData' , u'cch' , u'pTopicName' , u'eAdaptationSettings' , 
			...
			(19, 0, None, None) , (3, 0, None, None) , ], 1 , 1 , 4 , 0 , 20 , (3, 0, None, None) , 0 , )),
]
...
ISpXMLRecoResult_vtables_ = [
	...
	(( u'GetXMLErrorInfo' , u'pSemanticErrorInfo' , ), 1610809345, (1610809345, (), [ (36, 0, None, None) , ], 1 , 1 , 4 , 0 , 60 , (3, 0, None, None) , 0 , )),
]
